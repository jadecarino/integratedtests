...
@Test
@TestAreas({"dockermanager", "localecosystem", "java13", "ubuntu"})
public class DockerLocalJava13Ubuntu extends AbstractDockerUbuntuLocal {
	...
	@JavaUbuntuInstallation(imageTag = "PRIMARY", javaVersion = JavaVersion.v13)
