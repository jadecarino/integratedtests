...
@Test
@TestAreas({"dockermanager", "localecosystem", "java15", "ubuntu"})
public class DockerLocalJava15Ubuntu extends AbstractDockerUbuntuLocal {
	...
	@JavaUbuntuInstallation(imageTag = "PRIMARY", javaVersion = JavaVersion.v15)
