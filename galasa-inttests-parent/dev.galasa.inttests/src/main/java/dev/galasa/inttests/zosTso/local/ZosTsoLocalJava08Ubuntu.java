package dev.galasa.inttests.zosTso.local;
...
import dev.galasa.inttests.zosTso.AbstractZosTsoLocal;
...
@Test
@TestAreas({"zosManager","localecosystem","java08","ubuntu"})
public class ZosTsoLocalJava08Ubuntu extends AbstractZosTsoLocal {
