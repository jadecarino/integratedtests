package dev.galasa.inttests.core.local.isolated;
...
@Test
@TestAreas({"coreManager","localecosystem","java08","ubuntu","isolated"})
public class CoreLocalJava08UbuntuIsolated extends AbstractCoreLocal {
